...
SQLALCHEMY_DATABASE_URL = f'postgresql+psycopy2://{settings.database_username}:{settings.database_password}@{settings.database_hostname}:{settings.database_port}/{settings.database_name}??sslmode=require'
